...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
   <?php 
       $jscss = new js_css; 
       echo $jscss->display(array('bootstrap','default','icon','all_skin','validate','fastclick','datatables','icon_unibba'));
  ?>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/dist/js/Admin/frm_dt_dsn.js"></script>
